...
const Hero = () => {
  ...
  const result = [
    "https://static.toiimg.com/thumb/msid-70064013,width-400,resizemode-4/70064013.jpg",
    ...
    "https://www.gmhs40a.in/wp-content/uploads/2022/04/DSC_5220.jpg",
  ].map((i, index) => {
    return (
    ...
    <div className="text-black pt-[60px] ">
      ...
      >
        <div className="font-extrabold text-[75px] text-white">
          <TypeAnimation
            sequence={["ಮಚ್ಚ ಲ್ಯಾಂಗ್", 1000, "Macha  Lang", 1000]}
            wrapper="span"
            speed={50}
        ...
        <div className="text-[#FFF4A3!important] font-bold text-[25px] hidden lg:block">
          ಕರ್ನಾಟಕದಲ್ಲಿ ಕನ್ನಡಿಗನೇ ಸಾರ್ವಭೌಮ
        </div>
        <div className="text-[#FFF4A3!important] font-bold text-[25px] lg:hidden text-center">
          {" "}
          ಕರ್ನಾಟಕದಲ್ಲಿ <br></br>ಕನ್ನಡಿಗನೇ ಸಾರ್ವಭೌಮ
        </div>
        <button
          className="bg-[#04AA6D] h-[35px] rounded-3xl w-[250px] text-white font-semibold hover:bg-[#028555]"
      ...
      <div className="lg:w-full  h-[500px] bg-[#D9EEE1!important]">
        <div className="flex flex-col lg:flex-row justify-center items-center pt-[90px] lg:gap-[40px] gap-[40px] ">
          <div>
            <div className="lg:text-[60px] text-[40px] font-bold pb-4">
              About lang
            </div>
            <div className="text-xl font-semibold">
              The language for kannadigas
            </div>
