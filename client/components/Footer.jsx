...
const Footer = () => {
  return (
    <footer className="text-white ">
      <div
        className="p-[70px] flex flex-col lg:flex-row lg:justify-between justify-center items-center text-center
            bg-[#1f1f1f] "
      >
        <div className="flex flex-col gap-6">
          ...
          <div className="flex justify-between items-center  ">
            ...
            <img
              className="invert"
              src="	https://cdn-icons-png.flaticon.com/128/5968/5968968.png"
              width={33}
            />
          </div>
          <h1 className="font-extrabold text-2xl text-yellow-200 hover:underline font-sans">
            Give Feedback
          </h1>
